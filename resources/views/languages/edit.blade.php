...
<div class="form-container">
    ...
    <form action="{{ route('languages.update', $language) }}" method="POST" class="form">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="code" class="form-label">Código del Idioma</label>
            <input type="text" name="code" id="code" value="{{ $language->code }}" required class="form-control" placeholder="Ejemplo: ENG">
        </div>
